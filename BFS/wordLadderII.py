'''
0126 Word Ladder II
# A lab problem in CS61B

Each word: a vertex in the undirected graph
An edge exists if the two vertices next to it 
differ exactly 'one' character.

Create an undirected graph -> Use BFS to find
